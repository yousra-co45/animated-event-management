    ...
    <footer className="relative bg-[#0b1329] text-gray-300 border-t border-gray-800/80 mt-auto overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Column 2: Quick Links with Modern Arrow Hover */}
          ...
          <div className="space-y-4" data-aos="fade-up" data-aos-delay="300">
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start space-x-3">
                ...
                <span>Codecelix Rawalpindi,<br />Pakistan</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="hover:text-white transition-colors cursor-pointer">support@eventhub.com</span>
              </li>
            </ul>
          </div>

          {/* Column 4: Newsletter Subscriber with Glow Input */}
